...
jsPsych.plugins['image-slider-response_InstrMAS-colorSquare'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-slider-response_InstrMAS-colorSquare', 'stimulus', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div style="width:100px;height:100px; margin: 0 auto 3em auto; background-color:rgb('+trial.stimulus+');"></div>'
