  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      */
      ...
      //add prompt & change text color
    /*
        html += '<span style="color: RGB(255, 255, 255)">'+trial.prompt+'</span>';
    } else if (question.prompt !== null && trial.text_color == "black"){
        html += '<span style="color: RGB(0,0,0)">'+trial.prompt+'</span>';
    } else {
        html += '<span style="color: RGB(0,0,0)">'+trial.prompt+'</span>';
    }
    */
